    ...
    return (
        <div className="flex justify-center"> {/* ADD THIS */}
            <div className="w-full max-w-7xl"> {/* ADD THIS */}
                <PatientDashboard
                    patientListEndpoint="https://maternal-gest-backend.onrender.com/api/ongoing-patients"
                    dashboardApiEndpoint="https://maternal-gest-backend.onrender.com/api/ongoing-patientDetails"
